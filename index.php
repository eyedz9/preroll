	...
	if (isset($_POST['submit'])){
		...
		if (in_array($file_ext,$allowed_file_types)) {	
			...
			if (file_exists("upload/" . $newfilename)) {
				...
				exec("/usr/bin/ffmpeg -i ".$uploadLocation.$filename." -vcodec libx264 -b 900k -r 25 -aspect 16:9 -s ".$vidsize." -ss 00:00:01 -to 00:00:31 -c ".$convertedLocation.$convname." 2>&1");
			}
		}
